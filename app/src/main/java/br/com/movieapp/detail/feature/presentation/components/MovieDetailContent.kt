...
import br.com.movieapp.detail.feature.data.mapper.toMovie
...
fun MovieDetailContentPreview() {
    val movieDetail = MovieDetails(
        id = 1,
        title = "Homem Aranha",
        genres = listOf("Ação", "Aventura", "Super herói"),
        overview = "Depois do nosso herói ter sido desmascarado pelo seu inimigo Mysterio, Perter Parker já não é capaz de separar...",
        backdropPathUrl = "",
